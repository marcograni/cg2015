...
Feature.inherits(PosterVir1, Feature);

function PosterVir1(feature) {
  Feature.call(this, feature);
}

PosterVir1.prototype.style = {
                prefix: "fa",
                icon: "minus",
                zIndex: 3
            };

PosterVir1.prototype.in_graph = true;
PosterVir1.prototype.in_2D_map = false;

PosterVir1.prototype.get3DModel = function() {

  var o1=new THREE.Object3D();
  o1.rotation.x=Math.PI/2;

var poster=THREE.ImageUtils.loadTexture("../../assets/textures/PosterVir1.jpg" )
