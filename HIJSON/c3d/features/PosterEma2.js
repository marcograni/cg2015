...
Feature.inherits(PosterEma2, Feature);

function PosterEma2(feature) {
  Feature.call(this, feature);
}

PosterEma2.prototype.style = {
                prefix: "fa",
                icon: "minus",
                zIndex: 3
            };

PosterEma2.prototype.in_graph = true;
PosterEma2.prototype.in_2D_map = false;

PosterEma2.prototype.get3DModel = function() {

  var o1=new THREE.Object3D();
  o1.rotation.x=Math.PI/2;

var poster=THREE.ImageUtils.loadTexture("../../assets/textures/PosterEma2.jpg" )
