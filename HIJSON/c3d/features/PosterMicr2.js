...
Feature.inherits(PosterMicr2, Feature);

function PosterMicr2(feature) {
  Feature.call(this, feature);
}

PosterMicr2.prototype.style = {
                prefix: "fa",
                icon: "minus",
                zIndex: 3
            };

PosterMicr2.prototype.in_graph = true;
PosterMicr2.prototype.in_2D_map = false;

PosterMicr2.prototype.get3DModel = function() {

  var o1=new THREE.Object3D();
  o1.rotation.x=Math.PI/2;

var poster=THREE.ImageUtils.loadTexture("../../assets/textures/PosterMicr2.jpg" )
